...
public class TextureAssign : EditorWindow
{
    ...
    const string albedoExtension = "";
	const string metallicExtension = "_MetallicSmoothness";
	const string specularExtension = "_ref";
	const string normalExtension = "_normal";
	const string heightExtension = "_height-ssbump"; //This texture has to be manually added to the export preset in SP, so make sure the name is correct.
